...
void setup()
{
  ...
  myLED.setPixel(0, L_BLUE, 0);    // set the LED colour and show it
  myLED.setPixel(1, L_BLUE, 0);
  myLED.setPixel(2, L_BLUE, 0);
  myLED.setPixel(3, L_BLUE, 0);
...
void loop()
{
  if (led == 1) {
    ...
    myLED.brightness(1, 1);
    myLED.brightness(2, 1);
    myLED.brightness(3, 1);
  }
  else {
    myLED.brightness(0, 0);
    myLED.brightness(1, 0);
    myLED.brightness(2, 0);
    myLED.brightness(3, 0);
  }
